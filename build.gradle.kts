...
dependencies {
    ...
    implementation("org.everbuild.blocksandstuff:blocksandstuff-blocks:1.10.0-SNAPSHOT")
    implementation("org.everbuild.blocksandstuff:blocksandstuff-fluids:1.10.0-SNAPSHOT")
}
